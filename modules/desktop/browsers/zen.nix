# modules/browser/zen.nix --- https://librewolf.net/
#
  ...
  config = mkIf cfg.enable {
    user.packages = with pkgs; [
      ...
      (writeShellScriptBin "zen" ''
        ...
        exec "${config.programs.firefox.package}/bin/zen" "$@"
      '')
    ...
    programs.firefox = {
      ...
      preferences = {
        ...
        "browser.globalprivacycontrol.enabled" = true;
    ...
    home = let
      localDir = "${config.home.fakeDir}/.zen";
    in {
      ...
      file."${localDir}/${cfg.profileName}.default/user.js" = mkIf (cfg.settings != {} || cfg.extraConfig != "") {
        text = ''
