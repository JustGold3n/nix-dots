...
in {
  ...
  config = {
    ...
    home-manager = {
      ...
      # files easily to my $HOME, but 'home-manager.users.gold3n.home.file.*'
      # is much too long and harder to maintain, so I've made aliases in:
      #
      #   home.file        ->  home-manager.users.gold3n.home.file
      #   home.configFile  ->  home-manager.users.gold3n.home.xdg.configFile
      #   home.dataFile    ->  home-manager.users.gold3n.home.xdg.dataFile
